...
class BlueTrajectoryPlanner(object):
    ...
    def __init__(self):
        ...
        self.goal.x, self.goal.y = 5.2, 4.4
    ...
    def localGoalCalculation(self):
        ...
        for id, point in enumerate(self.local_path):
            marker = Marker()
            marker.header.frame_id = "blue/velodyne" #TODO publish in the tf with the namespace blue to coordinate the frames
    ...
    def controlActionCalculation(self):
        ...
        #Variable initialization
        min_error = 1000
        # Define weights for distance and angle
        weight_distance = 0.1
        weight_angle = 1.0
